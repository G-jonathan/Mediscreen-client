...
public class PatientController {
    ...
    public String showUpdateForm(@PathVariable("id") int id, Model model) {
        ...
        LOGGER.info("[CONTROLLER]-> showUpdateForm patient = " + patient);
    ...
    public String updatePatient(@PathVariable("id") int id, @Valid @ModelAttribute("patient") PatientBean patient, BindingResult bindingResult) {
        ...
        if (bindingResult.hasErrors()) {
            ...
            LOGGER.error("[CONTROLLER]-> updatePatient() : BindingResult errors : " + bindingResult.getAllErrors());
            return "update-patient";
        }
